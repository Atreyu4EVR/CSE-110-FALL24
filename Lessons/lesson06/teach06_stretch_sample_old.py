...
Purpose: Amusement park ride requirements, including stretch challenges.
"""
...
if is_second_rider.lower() == "yes":
    ...
    if height1 < 36 or height2 < 36:
        ...
        if age1 >= 12 and age2 >= 12:
            ...
            # One of these riders is less than 12
            if age1 < 12:
                # Person 1 is a child

                # Rule 5
                if age2 >= 18:
                    # We know height1 is at least 36 from a check above
                    can_ride = True

                # Rule 4
                if height1 >= 42 and age2 >= 15 and height2 >= 60:
                    # We could have said:
                    # if height1 >= 42 and ((age2 >= 15 and height2 >= 60) or age2 >= 18):
                    # but we have already handled the adult case with rule 5

                    can_ride = True
            else: # Person 1 is not a child (so person 2 is)
                # Rule 5
                if age1 >= 18:
                    # We know height2 is at least 36 from a check above
                    can_ride = True

                # Rule 4
                if height2 >= 42 and age1 >= 15 and height1 >= 60:
                    can_ride = True
